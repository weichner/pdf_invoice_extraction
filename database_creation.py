...
register = sqlalchemy.Table(
    ...
    sqlalchemy.Column("company_name", sqlalchemy.String(length=500), nullable=False),
    sqlalchemy.Column("company_address", sqlalchemy.String(length=500), nullable=False),
